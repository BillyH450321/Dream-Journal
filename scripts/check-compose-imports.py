...
SYMBOL_IMPORTS: dict[str, str] = {
    ...
    r"\bitems\s*\(": "androidx.compose.foundation.lazy.items",
    r"\bIcon\s*\(": "androidx.compose.material3.Icon",
    r"FontStyle\.": "androidx.compose.ui.text.font.FontStyle",
    r"\bimePadding\s*\(": "androidx.compose.foundation.layout.imePadding",
    r"\bnavigationBarsPadding\s*\(": "androidx.compose.foundation.layout.navigationBarsPadding",
    r"\baspectRatio\s*\(": "androidx.compose.foundation.layout.aspectRatio",
